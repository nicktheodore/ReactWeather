...
/***/ function(module, exports, __webpack_require__) {
	...
	var Careers = __webpack_require__(227);
	...
	React.createElement(
	  ...
	  React.createElement(
	    ...
	    React.createElement(Route, { path: 'careers', component: Careers }),
	...
	var Nav = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        Link,
	        { to: '/careers', activeClassName: 'active', activeStyle: { fontWeight: 'bold' } },
	        'Careers'
	      )
	    );
	  }
